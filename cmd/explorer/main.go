...
func main() {
	...
	router.HandleFunc("/address/{address}/zrc20", handlers.ExecutionAddressZrc20Transactions).Methods("GET")
	router.HandleFunc("/address/{address}/zrc721", handlers.ExecutionAddressZrc721Transactions).Methods("GET")
	router.HandleFunc("/address/{address}/zrc1155", handlers.ExecutionAddressZrc1155Transactions).Methods("GET")
