...
// SqrcTn1MetaData contains all meta data concerning the SqrcTn1 contract.
var SqrcTn1MetaData = &bind.MetaData{
...
// SqrcTn1ABI is the input ABI used to generate the binding from.
// Deprecated: Use SqrcTn1MetaData.ABI instead.
var SqrcTn1ABI = SqrcTn1MetaData.ABI

// SqrcTn1Bin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use SqrcTn1MetaData.Bin instead.
var SqrcTn1Bin = SqrcTn1MetaData.Bin

// DeploySqrcTn1 deploys a new QRL contract, binding an instance of SqrcTn1 to it.
func DeploySqrcTn1(auth *bind.TransactOpts, backend bind.ContractBackend, name_ string, symbol_ string) (common.Address, *types.Transaction, *SqrcTn1, error) {
	parsed, err := SqrcTn1MetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(SqrcTn1Bin), backend, name_, symbol_)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &SqrcTn1{SqrcTn1Caller: SqrcTn1Caller{contract: contract}, SqrcTn1Transactor: SqrcTn1Transactor{contract: contract}, SqrcTn1Filterer: SqrcTn1Filterer{contract: contract}}, nil
}

// SqrcTn1 is an auto generated Go binding around a QRL contract.
type SqrcTn1 struct {
	SqrcTn1Caller     // Read-only binding to the contract
	SqrcTn1Transactor // Write-only binding to the contract
	SqrcTn1Filterer   // Log filterer for contract events
}

// SqrcTn1Caller is an auto generated read-only Go binding around a QRL contract.
type SqrcTn1Caller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// SqrcTn1Transactor is an auto generated write-only Go binding around a QRL contract.
type SqrcTn1Transactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// SqrcTn1Filterer is an auto generated log filtering Go binding around a QRL contract events.
type SqrcTn1Filterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// SqrcTn1Session is an auto generated Go binding around a QRL contract,
// with pre-set call and transact options.
type SqrcTn1Session struct {
	Contract     *SqrcTn1          // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// SqrcTn1CallerSession is an auto generated read-only Go binding around a QRL contract,
// with pre-set call options.
type SqrcTn1CallerSession struct {
	Contract *SqrcTn1Caller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts  // Call options to use throughout this session
}

// SqrcTn1TransactorSession is an auto generated write-only Go binding around a QRL contract,
// with pre-set transact options.
type SqrcTn1TransactorSession struct {
	Contract     *SqrcTn1Transactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts  // Transaction auth options to use throughout this session
}

// SqrcTn1Raw is an auto generated low-level Go binding around a QRL contract.
type SqrcTn1Raw struct {
	Contract *SqrcTn1 // Generic contract binding to access the raw methods on
}

// SqrcTn1CallerRaw is an auto generated low-level read-only Go binding around a QRL contract.
type SqrcTn1CallerRaw struct {
	Contract *SqrcTn1Caller // Generic read-only contract binding to access the raw methods on
}

// SqrcTn1TransactorRaw is an auto generated low-level write-only Go binding around a QRL contract.
type SqrcTn1TransactorRaw struct {
	Contract *SqrcTn1Transactor // Generic write-only contract binding to access the raw methods on
}

// NewSqrcTn1 creates a new instance of SqrcTn1, bound to a specific deployed contract.
func NewSqrcTn1(address common.Address, backend bind.ContractBackend) (*SqrcTn1, error) {
	contract, err := bindSqrcTn1(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &SqrcTn1{SqrcTn1Caller: SqrcTn1Caller{contract: contract}, SqrcTn1Transactor: SqrcTn1Transactor{contract: contract}, SqrcTn1Filterer: SqrcTn1Filterer{contract: contract}}, nil
}

// NewSqrcTn1Caller creates a new read-only instance of SqrcTn1, bound to a specific deployed contract.
func NewSqrcTn1Caller(address common.Address, caller bind.ContractCaller) (*SqrcTn1Caller, error) {
	contract, err := bindSqrcTn1(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &SqrcTn1Caller{contract: contract}, nil
}

// NewSqrcTn1Transactor creates a new write-only instance of SqrcTn1, bound to a specific deployed contract.
func NewSqrcTn1Transactor(address common.Address, transactor bind.ContractTransactor) (*SqrcTn1Transactor, error) {
	contract, err := bindSqrcTn1(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &SqrcTn1Transactor{contract: contract}, nil
}

// NewSqrcTn1Filterer creates a new log filterer instance of SqrcTn1, bound to a specific deployed contract.
func NewSqrcTn1Filterer(address common.Address, filterer bind.ContractFilterer) (*SqrcTn1Filterer, error) {
	contract, err := bindSqrcTn1(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &SqrcTn1Filterer{contract: contract}, nil
}

// bindSqrcTn1 binds a generic wrapper to an already deployed contract.
func bindSqrcTn1(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(SqrcTn1ABI))
	if err != nil {
		return nil, err
	}
...
// returns.
func (_SqrcTn1 *SqrcTn1Raw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _SqrcTn1.Contract.SqrcTn1Caller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_SqrcTn1 *SqrcTn1Raw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _SqrcTn1.Contract.SqrcTn1Transactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_SqrcTn1 *SqrcTn1Raw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _SqrcTn1.Contract.SqrcTn1Transactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_SqrcTn1 *SqrcTn1CallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _SqrcTn1.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_SqrcTn1 *SqrcTn1TransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _SqrcTn1.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_SqrcTn1 *SqrcTn1TransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _SqrcTn1.Contract.contract.Transact(opts, method, params...)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(address owner) view returns(uint256)
func (_SqrcTn1 *SqrcTn1Caller) BalanceOf(opts *bind.CallOpts, owner common.Address) (*big.Int, error) {
	var out []interface{}
	err := _SqrcTn1.contract.Call(opts, &out, "balanceOf", owner)
...
//
// Solidity: function balanceOf(address owner) view returns(uint256)
func (_SqrcTn1 *SqrcTn1Session) BalanceOf(owner common.Address) (*big.Int, error) {
	return _SqrcTn1.Contract.BalanceOf(&_SqrcTn1.CallOpts, owner)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(address owner) view returns(uint256)
func (_SqrcTn1 *SqrcTn1CallerSession) BalanceOf(owner common.Address) (*big.Int, error) {
	return _SqrcTn1.Contract.BalanceOf(&_SqrcTn1.CallOpts, owner)
}
...
func (_SqrcTn1 *SqrcTn1Caller) GetApproved(opts *bind.CallOpts, tokenId *big.Int) (common.Address, error) {
	var out []interface{}
	err := _SqrcTn1.contract.Call(opts, &out, "getApproved", tokenId)
...
//
// Solidity: function getApproved(uint256 tokenId) view returns(address)
func (_SqrcTn1 *SqrcTn1Session) GetApproved(tokenId *big.Int) (common.Address, error) {
	return _SqrcTn1.Contract.GetApproved(&_SqrcTn1.CallOpts, tokenId)
}

// GetApproved is a free data retrieval call binding the contract method 0x081812fc.
//
// Solidity: function getApproved(uint256 tokenId) view returns(address)
func (_SqrcTn1 *SqrcTn1CallerSession) GetApproved(tokenId *big.Int) (common.Address, error) {
	return _SqrcTn1.Contract.GetApproved(&_SqrcTn1.CallOpts, tokenId)
}
...
func (_SqrcTn1 *SqrcTn1Caller) IsApprovedForAll(opts *bind.CallOpts, owner common.Address, operator common.Address) (bool, error) {
	var out []interface{}
	err := _SqrcTn1.contract.Call(opts, &out, "isApprovedForAll", owner, operator)
...
//
// Solidity: function isApprovedForAll(address owner, address operator) view returns(bool)
func (_SqrcTn1 *SqrcTn1Session) IsApprovedForAll(owner common.Address, operator common.Address) (bool, error) {
	return _SqrcTn1.Contract.IsApprovedForAll(&_SqrcTn1.CallOpts, owner, operator)
}

// IsApprovedForAll is a free data retrieval call binding the contract method 0xe985e9c5.
//
// Solidity: function isApprovedForAll(address owner, address operator) view returns(bool)
func (_SqrcTn1 *SqrcTn1CallerSession) IsApprovedForAll(owner common.Address, operator common.Address) (bool, error) {
	return _SqrcTn1.Contract.IsApprovedForAll(&_SqrcTn1.CallOpts, owner, operator)
}
...
func (_SqrcTn1 *SqrcTn1Caller) Name(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _SqrcTn1.contract.Call(opts, &out, "name")
...
//
// Solidity: function name() view returns(string)
func (_SqrcTn1 *SqrcTn1Session) Name() (string, error) {
	return _SqrcTn1.Contract.Name(&_SqrcTn1.CallOpts)
}

// Name is a free data retrieval call binding the contract method 0x06fdde03.
//
// Solidity: function name() view returns(string)
func (_SqrcTn1 *SqrcTn1CallerSession) Name() (string, error) {
	return _SqrcTn1.Contract.Name(&_SqrcTn1.CallOpts)
}
...
func (_SqrcTn1 *SqrcTn1Caller) OwnerOf(opts *bind.CallOpts, tokenId *big.Int) (common.Address, error) {
	var out []interface{}
	err := _SqrcTn1.contract.Call(opts, &out, "ownerOf", tokenId)
...
//
// Solidity: function ownerOf(uint256 tokenId) view returns(address)
func (_SqrcTn1 *SqrcTn1Session) OwnerOf(tokenId *big.Int) (common.Address, error) {
	return _SqrcTn1.Contract.OwnerOf(&_SqrcTn1.CallOpts, tokenId)
}

// OwnerOf is a free data retrieval call binding the contract method 0x6352211e.
//
// Solidity: function ownerOf(uint256 tokenId) view returns(address)
func (_SqrcTn1 *SqrcTn1CallerSession) OwnerOf(tokenId *big.Int) (common.Address, error) {
	return _SqrcTn1.Contract.OwnerOf(&_SqrcTn1.CallOpts, tokenId)
}
...
func (_SqrcTn1 *SqrcTn1Caller) SupportsInterface(opts *bind.CallOpts, interfaceId [4]byte) (bool, error) {
	var out []interface{}
	err := _SqrcTn1.contract.Call(opts, &out, "supportsInterface", interfaceId)
...
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (_SqrcTn1 *SqrcTn1Session) SupportsInterface(interfaceId [4]byte) (bool, error) {
	return _SqrcTn1.Contract.SupportsInterface(&_SqrcTn1.CallOpts, interfaceId)
}

// SupportsInterface is a free data retrieval call binding the contract method 0x01ffc9a7.
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (_SqrcTn1 *SqrcTn1CallerSession) SupportsInterface(interfaceId [4]byte) (bool, error) {
	return _SqrcTn1.Contract.SupportsInterface(&_SqrcTn1.CallOpts, interfaceId)
}
...
func (_SqrcTn1 *SqrcTn1Caller) Symbol(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _SqrcTn1.contract.Call(opts, &out, "symbol")
...
//
// Solidity: function symbol() view returns(string)
func (_SqrcTn1 *SqrcTn1Session) Symbol() (string, error) {
	return _SqrcTn1.Contract.Symbol(&_SqrcTn1.CallOpts)
}

// Symbol is a free data retrieval call binding the contract method 0x95d89b41.
//
// Solidity: function symbol() view returns(string)
func (_SqrcTn1 *SqrcTn1CallerSession) Symbol() (string, error) {
	return _SqrcTn1.Contract.Symbol(&_SqrcTn1.CallOpts)
}
...
func (_SqrcTn1 *SqrcTn1Caller) TokenURI(opts *bind.CallOpts, tokenId *big.Int) (string, error) {
	var out []interface{}
	err := _SqrcTn1.contract.Call(opts, &out, "tokenURI", tokenId)
...
//
// Solidity: function tokenURI(uint256 tokenId) view returns(string)
func (_SqrcTn1 *SqrcTn1Session) TokenURI(tokenId *big.Int) (string, error) {
	return _SqrcTn1.Contract.TokenURI(&_SqrcTn1.CallOpts, tokenId)
}

// TokenURI is a free data retrieval call binding the contract method 0xc87b56dd.
//
// Solidity: function tokenURI(uint256 tokenId) view returns(string)
func (_SqrcTn1 *SqrcTn1CallerSession) TokenURI(tokenId *big.Int) (string, error) {
	return _SqrcTn1.Contract.TokenURI(&_SqrcTn1.CallOpts, tokenId)
}
...
func (_SqrcTn1 *SqrcTn1Transactor) Approve(opts *bind.TransactOpts, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _SqrcTn1.contract.Transact(opts, "approve", to, tokenId)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address to, uint256 tokenId) returns()
func (_SqrcTn1 *SqrcTn1Session) Approve(to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _SqrcTn1.Contract.Approve(&_SqrcTn1.TransactOpts, to, tokenId)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address to, uint256 tokenId) returns()
func (_SqrcTn1 *SqrcTn1TransactorSession) Approve(to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _SqrcTn1.Contract.Approve(&_SqrcTn1.TransactOpts, to, tokenId)
}
...
func (_SqrcTn1 *SqrcTn1Transactor) SafeTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _SqrcTn1.contract.Transact(opts, "safeTransferFrom", from, to, tokenId)
}

// SafeTransferFrom is a paid mutator transaction binding the contract method 0x42842e0e.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId) returns()
func (_SqrcTn1 *SqrcTn1Session) SafeTransferFrom(from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _SqrcTn1.Contract.SafeTransferFrom(&_SqrcTn1.TransactOpts, from, to, tokenId)
}

// SafeTransferFrom is a paid mutator transaction binding the contract method 0x42842e0e.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId) returns()
func (_SqrcTn1 *SqrcTn1TransactorSession) SafeTransferFrom(from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _SqrcTn1.Contract.SafeTransferFrom(&_SqrcTn1.TransactOpts, from, to, tokenId)
}
...
func (_SqrcTn1 *SqrcTn1Transactor) SafeTransferFrom0(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _SqrcTn1.contract.Transact(opts, "safeTransferFrom0", from, to, tokenId, data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes data) returns()
func (_SqrcTn1 *SqrcTn1Session) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _SqrcTn1.Contract.SafeTransferFrom0(&_SqrcTn1.TransactOpts, from, to, tokenId, data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes data) returns()
func (_SqrcTn1 *SqrcTn1TransactorSession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _SqrcTn1.Contract.SafeTransferFrom0(&_SqrcTn1.TransactOpts, from, to, tokenId, data)
}
...
func (_SqrcTn1 *SqrcTn1Transactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, approved bool) (*types.Transaction, error) {
	return _SqrcTn1.contract.Transact(opts, "setApprovalForAll", operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_SqrcTn1 *SqrcTn1Session) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _SqrcTn1.Contract.SetApprovalForAll(&_SqrcTn1.TransactOpts, operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_SqrcTn1 *SqrcTn1TransactorSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _SqrcTn1.Contract.SetApprovalForAll(&_SqrcTn1.TransactOpts, operator, approved)
}
...
func (_SqrcTn1 *SqrcTn1Transactor) TransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _SqrcTn1.contract.Transact(opts, "transferFrom", from, to, tokenId)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address from, address to, uint256 tokenId) returns()
func (_SqrcTn1 *SqrcTn1Session) TransferFrom(from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _SqrcTn1.Contract.TransferFrom(&_SqrcTn1.TransactOpts, from, to, tokenId)
}

// TransferFrom is a paid mutator transaction binding the contract method 0x23b872dd.
//
// Solidity: function transferFrom(address from, address to, uint256 tokenId) returns()
func (_SqrcTn1 *SqrcTn1TransactorSession) TransferFrom(from common.Address, to common.Address, tokenId *big.Int) (*types.Transaction, error) {
	return _SqrcTn1.Contract.TransferFrom(&_SqrcTn1.TransactOpts, from, to, tokenId)
}

// SqrcTn1ApprovalIterator is returned from FilterApproval and is used to iterate over the raw logs and unpacked data for Approval events raised by the SqrcTn1 contract.
type SqrcTn1ApprovalIterator struct {
	Event *SqrcTn1Approval // Event containing the contract specifics and raw log
...
func (it *SqrcTn1ApprovalIterator) Next() bool {
...
func (it *SqrcTn1ApprovalIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SqrcTn1ApprovalIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SqrcTn1Approval represents a Approval event raised by the SqrcTn1 contract.
type SqrcTn1Approval struct {
...
func (_SqrcTn1 *SqrcTn1Filterer) FilterApproval(opts *bind.FilterOpts, owner []common.Address, approved []common.Address, tokenId []*big.Int) (*SqrcTn1ApprovalIterator, error) {
	...
	logs, sub, err := _SqrcTn1.contract.FilterLogs(opts, "Approval", ownerRule, approvedRule, tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &SqrcTn1ApprovalIterator{contract: _SqrcTn1.contract, event: "Approval", logs: logs, sub: sub}, nil
}

// WatchApproval is a free log subscription operation binding the contract event 0x8c5be1e5ebec7d5bd14f71427d1e84f3dd0314c0f7b2291e5b200ac8c7c3b925.
//
// Solidity: event Approval(address indexed owner, address indexed approved, uint256 indexed tokenId)
func (_SqrcTn1 *SqrcTn1Filterer) WatchApproval(opts *bind.WatchOpts, sink chan<- *SqrcTn1Approval, owner []common.Address, approved []common.Address, tokenId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _SqrcTn1.contract.WatchLogs(opts, "Approval", ownerRule, approvedRule, tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(SqrcTn1Approval)
				if err := _SqrcTn1.contract.UnpackLog(event, "Approval", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Approval(address indexed owner, address indexed approved, uint256 indexed tokenId)
func (_SqrcTn1 *SqrcTn1Filterer) ParseApproval(log types.Log) (*SqrcTn1Approval, error) {
	event := new(SqrcTn1Approval)
	if err := _SqrcTn1.contract.UnpackLog(event, "Approval", log); err != nil {
		return nil, err
	}
...
// SqrcTn1ApprovalForAllIterator is returned from FilterApprovalForAll and is used to iterate over the raw logs and unpacked data for ApprovalForAll events raised by the SqrcTn1 contract.
type SqrcTn1ApprovalForAllIterator struct {
	Event *SqrcTn1ApprovalForAll // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SqrcTn1ApprovalForAllIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SqrcTn1ApprovalForAll)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SqrcTn1ApprovalForAllIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SqrcTn1ApprovalForAllIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SqrcTn1ApprovalForAll represents a ApprovalForAll event raised by the SqrcTn1 contract.
type SqrcTn1ApprovalForAll struct {
	Owner    common.Address
...
func (_SqrcTn1 *SqrcTn1Filterer) FilterApprovalForAll(opts *bind.FilterOpts, owner []common.Address, operator []common.Address) (*SqrcTn1ApprovalForAllIterator, error) {
	...
	logs, sub, err := _SqrcTn1.contract.FilterLogs(opts, "ApprovalForAll", ownerRule, operatorRule)
	if err != nil {
		return nil, err
	}
	return &SqrcTn1ApprovalForAllIterator{contract: _SqrcTn1.contract, event: "ApprovalForAll", logs: logs, sub: sub}, nil
}

// WatchApprovalForAll is a free log subscription operation binding the contract event 0x17307eab39ab6107e8899845ad3d59bd9653f200f220920489ca2b5937696c31.
//
// Solidity: event ApprovalForAll(address indexed owner, address indexed operator, bool approved)
func (_SqrcTn1 *SqrcTn1Filterer) WatchApprovalForAll(opts *bind.WatchOpts, sink chan<- *SqrcTn1ApprovalForAll, owner []common.Address, operator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _SqrcTn1.contract.WatchLogs(opts, "ApprovalForAll", ownerRule, operatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SqrcTn1ApprovalForAll)
				if err := _SqrcTn1.contract.UnpackLog(event, "ApprovalForAll", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ApprovalForAll(address indexed owner, address indexed operator, bool approved)
func (_SqrcTn1 *SqrcTn1Filterer) ParseApprovalForAll(log types.Log) (*SqrcTn1ApprovalForAll, error) {
	event := new(SqrcTn1ApprovalForAll)
	if err := _SqrcTn1.contract.UnpackLog(event, "ApprovalForAll", log); err != nil {
		return nil, err
	}
...
// SqrcTn1TransferIterator is returned from FilterTransfer and is used to iterate over the raw logs and unpacked data for Transfer events raised by the SqrcTn1 contract.
type SqrcTn1TransferIterator struct {
	Event *SqrcTn1Transfer // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SqrcTn1TransferIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SqrcTn1TransferIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SqrcTn1TransferIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SqrcTn1Transfer represents a Transfer event raised by the SqrcTn1 contract.
type SqrcTn1Transfer struct {
	From    common.Address
	To      common.Address
	TokenId *big.Int
	Raw     types.Log // Blockchain specific contextual infos
...
func (_SqrcTn1 *SqrcTn1Filterer) FilterTransfer(opts *bind.FilterOpts, from []common.Address, to []common.Address, tokenId []*big.Int) (*SqrcTn1TransferIterator, error) {
	...
	logs, sub, err := _SqrcTn1.contract.FilterLogs(opts, "Transfer", fromRule, toRule, tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &SqrcTn1TransferIterator{contract: _SqrcTn1.contract, event: "Transfer", logs: logs, sub: sub}, nil
}

// WatchTransfer is a free log subscription operation binding the contract event 0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef.
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)
func (_SqrcTn1 *SqrcTn1Filterer) WatchTransfer(opts *bind.WatchOpts, sink chan<- *SqrcTn1Transfer, from []common.Address, to []common.Address, tokenId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _SqrcTn1.contract.WatchLogs(opts, "Transfer", fromRule, toRule, tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SqrcTn1Transfer)
				if err := _SqrcTn1.contract.UnpackLog(event, "Transfer", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Transfer(address indexed from, address indexed to, uint256 indexed tokenId)
func (_SqrcTn1 *SqrcTn1Filterer) ParseTransfer(log types.Log) (*SqrcTn1Transfer, error) {
	event := new(SqrcTn1Transfer)
	if err := _SqrcTn1.contract.UnpackLog(event, "Transfer", log); err != nil {
		return nil, err
	}
