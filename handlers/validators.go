...
var searchPubkeyExactRE = regexp.MustCompile(`^(0x)?[0-9a-fA-F]{5184}`) // only search for pubkeys if string consists of 5184 hex-chars
var searchPubkeyLikeRE = regexp.MustCompile(`^(0x)?[0-9a-fA-F]{2,5184}`)
