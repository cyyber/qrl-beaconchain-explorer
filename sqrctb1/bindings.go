...
// SqrcTb1MetaData contains all meta data concerning the SqrcTb1 contract.
var SqrcTb1MetaData = &bind.MetaData{
...
// SqrcTb1ABI is the input ABI used to generate the binding from.
// Deprecated: Use SqrcTb1MetaData.ABI instead.
var SqrcTb1ABI = SqrcTb1MetaData.ABI

// SqrcTb1Bin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use SqrcTb1MetaData.Bin instead.
var SqrcTb1Bin = SqrcTb1MetaData.Bin

// DeploySqrcTb1 deploys a new QRL contract, binding an instance of SqrcTb1 to it.
func DeploySqrcTb1(auth *bind.TransactOpts, backend bind.ContractBackend, uri_ string) (common.Address, *types.Transaction, *SqrcTb1, error) {
	parsed, err := SqrcTb1MetaData.GetAbi()
	if err != nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(SqrcTb1Bin), backend, uri_)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &SqrcTb1{SqrcTb1Caller: SqrcTb1Caller{contract: contract}, SqrcTb1Transactor: SqrcTb1Transactor{contract: contract}, SqrcTb1Filterer: SqrcTb1Filterer{contract: contract}}, nil
}

// SqrcTb1 is an auto generated Go binding around a QRL contract.
type SqrcTb1 struct {
	SqrcTb1Caller     // Read-only binding to the contract
	SqrcTb1Transactor // Write-only binding to the contract
	SqrcTb1Filterer   // Log filterer for contract events
}

// SqrcTb1Caller is an auto generated read-only Go binding around a QRL contract.
type SqrcTb1Caller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// SqrcTb1Transactor is an auto generated write-only Go binding around a QRL contract.
type SqrcTb1Transactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// SqrcTb1Filterer is an auto generated log filtering Go binding around a QRL contract events.
type SqrcTb1Filterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// SqrcTb1Session is an auto generated Go binding around a QRL contract,
// with pre-set call and transact options.
type SqrcTb1Session struct {
	Contract     *SqrcTb1          // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// SqrcTb1CallerSession is an auto generated read-only Go binding around a QRL contract,
// with pre-set call options.
type SqrcTb1CallerSession struct {
	Contract *SqrcTb1Caller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts  // Call options to use throughout this session
}

// SqrcTb1TransactorSession is an auto generated write-only Go binding around a QRL contract,
// with pre-set transact options.
type SqrcTb1TransactorSession struct {
	Contract     *SqrcTb1Transactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts  // Transaction auth options to use throughout this session
}

// SqrcTb1Raw is an auto generated low-level Go binding around a QRL contract.
type SqrcTb1Raw struct {
	Contract *SqrcTb1 // Generic contract binding to access the raw methods on
}

// SqrcTb1CallerRaw is an auto generated low-level read-only Go binding around a QRL contract.
type SqrcTb1CallerRaw struct {
	Contract *SqrcTb1Caller // Generic read-only contract binding to access the raw methods on
}

// SqrcTb1TransactorRaw is an auto generated low-level write-only Go binding around a QRL contract.
type SqrcTb1TransactorRaw struct {
	Contract *SqrcTb1Transactor // Generic write-only contract binding to access the raw methods on
}

// NewSqrcTb1 creates a new instance of SqrcTb1, bound to a specific deployed contract.
func NewSqrcTb1(address common.Address, backend bind.ContractBackend) (*SqrcTb1, error) {
	contract, err := bindSqrcTb1(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &SqrcTb1{SqrcTb1Caller: SqrcTb1Caller{contract: contract}, SqrcTb1Transactor: SqrcTb1Transactor{contract: contract}, SqrcTb1Filterer: SqrcTb1Filterer{contract: contract}}, nil
}

// NewSqrcTb1Caller creates a new read-only instance of SqrcTb1, bound to a specific deployed contract.
func NewSqrcTb1Caller(address common.Address, caller bind.ContractCaller) (*SqrcTb1Caller, error) {
	contract, err := bindSqrcTb1(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &SqrcTb1Caller{contract: contract}, nil
}

// NewSqrcTb1Transactor creates a new write-only instance of SqrcTb1, bound to a specific deployed contract.
func NewSqrcTb1Transactor(address common.Address, transactor bind.ContractTransactor) (*SqrcTb1Transactor, error) {
	contract, err := bindSqrcTb1(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &SqrcTb1Transactor{contract: contract}, nil
}

// NewSqrcTb1Filterer creates a new log filterer instance of SqrcTb1, bound to a specific deployed contract.
func NewSqrcTb1Filterer(address common.Address, filterer bind.ContractFilterer) (*SqrcTb1Filterer, error) {
	contract, err := bindSqrcTb1(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &SqrcTb1Filterer{contract: contract}, nil
}

// bindSqrcTb1 binds a generic wrapper to an already deployed contract.
func bindSqrcTb1(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(SqrcTb1ABI))
	if err != nil {
		return nil, err
	}
...
// returns.
func (_SqrcTb1 *SqrcTb1Raw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _SqrcTb1.Contract.SqrcTb1Caller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_SqrcTb1 *SqrcTb1Raw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _SqrcTb1.Contract.SqrcTb1Transactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_SqrcTb1 *SqrcTb1Raw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _SqrcTb1.Contract.SqrcTb1Transactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_SqrcTb1 *SqrcTb1CallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _SqrcTb1.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_SqrcTb1 *SqrcTb1TransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _SqrcTb1.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_SqrcTb1 *SqrcTb1TransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _SqrcTb1.Contract.contract.Transact(opts, method, params...)
}

// BalanceOf is a free data retrieval call binding the contract method 0x00fdd58e.
//
// Solidity: function balanceOf(address account, uint256 id) view returns(uint256)
func (_SqrcTb1 *SqrcTb1Caller) BalanceOf(opts *bind.CallOpts, account common.Address, id *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SqrcTb1.contract.Call(opts, &out, "balanceOf", account, id)
...
//
// Solidity: function balanceOf(address account, uint256 id) view returns(uint256)
func (_SqrcTb1 *SqrcTb1Session) BalanceOf(account common.Address, id *big.Int) (*big.Int, error) {
	return _SqrcTb1.Contract.BalanceOf(&_SqrcTb1.CallOpts, account, id)
}

// BalanceOf is a free data retrieval call binding the contract method 0x00fdd58e.
//
// Solidity: function balanceOf(address account, uint256 id) view returns(uint256)
func (_SqrcTb1 *SqrcTb1CallerSession) BalanceOf(account common.Address, id *big.Int) (*big.Int, error) {
	return _SqrcTb1.Contract.BalanceOf(&_SqrcTb1.CallOpts, account, id)
}
...
func (_SqrcTb1 *SqrcTb1Caller) BalanceOfBatch(opts *bind.CallOpts, accounts []common.Address, ids []*big.Int) ([]*big.Int, error) {
	var out []interface{}
	err := _SqrcTb1.contract.Call(opts, &out, "balanceOfBatch", accounts, ids)
...
//
// Solidity: function balanceOfBatch(address[] accounts, uint256[] ids) view returns(uint256[])
func (_SqrcTb1 *SqrcTb1Session) BalanceOfBatch(accounts []common.Address, ids []*big.Int) ([]*big.Int, error) {
	return _SqrcTb1.Contract.BalanceOfBatch(&_SqrcTb1.CallOpts, accounts, ids)
}

// BalanceOfBatch is a free data retrieval call binding the contract method 0x4e1273f4.
//
// Solidity: function balanceOfBatch(address[] accounts, uint256[] ids) view returns(uint256[])
func (_SqrcTb1 *SqrcTb1CallerSession) BalanceOfBatch(accounts []common.Address, ids []*big.Int) ([]*big.Int, error) {
	return _SqrcTb1.Contract.BalanceOfBatch(&_SqrcTb1.CallOpts, accounts, ids)
}
...
func (_SqrcTb1 *SqrcTb1Caller) IsApprovedForAll(opts *bind.CallOpts, account common.Address, operator common.Address) (bool, error) {
	var out []interface{}
	err := _SqrcTb1.contract.Call(opts, &out, "isApprovedForAll", account, operator)
...
//
// Solidity: function isApprovedForAll(address account, address operator) view returns(bool)
func (_SqrcTb1 *SqrcTb1Session) IsApprovedForAll(account common.Address, operator common.Address) (bool, error) {
	return _SqrcTb1.Contract.IsApprovedForAll(&_SqrcTb1.CallOpts, account, operator)
}

// IsApprovedForAll is a free data retrieval call binding the contract method 0xe985e9c5.
//
// Solidity: function isApprovedForAll(address account, address operator) view returns(bool)
func (_SqrcTb1 *SqrcTb1CallerSession) IsApprovedForAll(account common.Address, operator common.Address) (bool, error) {
	return _SqrcTb1.Contract.IsApprovedForAll(&_SqrcTb1.CallOpts, account, operator)
}
...
func (_SqrcTb1 *SqrcTb1Caller) SupportsInterface(opts *bind.CallOpts, interfaceId [4]byte) (bool, error) {
	var out []interface{}
	err := _SqrcTb1.contract.Call(opts, &out, "supportsInterface", interfaceId)
...
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (_SqrcTb1 *SqrcTb1Session) SupportsInterface(interfaceId [4]byte) (bool, error) {
	return _SqrcTb1.Contract.SupportsInterface(&_SqrcTb1.CallOpts, interfaceId)
}

// SupportsInterface is a free data retrieval call binding the contract method 0x01ffc9a7.
//
// Solidity: function supportsInterface(bytes4 interfaceId) view returns(bool)
func (_SqrcTb1 *SqrcTb1CallerSession) SupportsInterface(interfaceId [4]byte) (bool, error) {
	return _SqrcTb1.Contract.SupportsInterface(&_SqrcTb1.CallOpts, interfaceId)
}
...
func (_SqrcTb1 *SqrcTb1Caller) Uri(opts *bind.CallOpts, arg0 *big.Int) (string, error) {
	var out []interface{}
	err := _SqrcTb1.contract.Call(opts, &out, "uri", arg0)
...
//
// Solidity: function uri(uint256 ) view returns(string)
func (_SqrcTb1 *SqrcTb1Session) Uri(arg0 *big.Int) (string, error) {
	return _SqrcTb1.Contract.Uri(&_SqrcTb1.CallOpts, arg0)
}

// Uri is a free data retrieval call binding the contract method 0x0e89341c.
//
// Solidity: function uri(uint256 ) view returns(string)
func (_SqrcTb1 *SqrcTb1CallerSession) Uri(arg0 *big.Int) (string, error) {
	return _SqrcTb1.Contract.Uri(&_SqrcTb1.CallOpts, arg0)
}
...
func (_SqrcTb1 *SqrcTb1Transactor) SafeBatchTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _SqrcTb1.contract.Transact(opts, "safeBatchTransferFrom", from, to, ids, amounts, data)
}

// SafeBatchTransferFrom is a paid mutator transaction binding the contract method 0x2eb2c2d6.
//
// Solidity: function safeBatchTransferFrom(address from, address to, uint256[] ids, uint256[] amounts, bytes data) returns()
func (_SqrcTb1 *SqrcTb1Session) SafeBatchTransferFrom(from common.Address, to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _SqrcTb1.Contract.SafeBatchTransferFrom(&_SqrcTb1.TransactOpts, from, to, ids, amounts, data)
}

// SafeBatchTransferFrom is a paid mutator transaction binding the contract method 0x2eb2c2d6.
//
// Solidity: function safeBatchTransferFrom(address from, address to, uint256[] ids, uint256[] amounts, bytes data) returns()
func (_SqrcTb1 *SqrcTb1TransactorSession) SafeBatchTransferFrom(from common.Address, to common.Address, ids []*big.Int, amounts []*big.Int, data []byte) (*types.Transaction, error) {
	return _SqrcTb1.Contract.SafeBatchTransferFrom(&_SqrcTb1.TransactOpts, from, to, ids, amounts, data)
}
...
func (_SqrcTb1 *SqrcTb1Transactor) SafeTransferFrom(opts *bind.TransactOpts, from common.Address, to common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _SqrcTb1.contract.Transact(opts, "safeTransferFrom", from, to, id, amount, data)
}

// SafeTransferFrom is a paid mutator transaction binding the contract method 0xf242432a.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes data) returns()
func (_SqrcTb1 *SqrcTb1Session) SafeTransferFrom(from common.Address, to common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _SqrcTb1.Contract.SafeTransferFrom(&_SqrcTb1.TransactOpts, from, to, id, amount, data)
}

// SafeTransferFrom is a paid mutator transaction binding the contract method 0xf242432a.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes data) returns()
func (_SqrcTb1 *SqrcTb1TransactorSession) SafeTransferFrom(from common.Address, to common.Address, id *big.Int, amount *big.Int, data []byte) (*types.Transaction, error) {
	return _SqrcTb1.Contract.SafeTransferFrom(&_SqrcTb1.TransactOpts, from, to, id, amount, data)
}
...
func (_SqrcTb1 *SqrcTb1Transactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, approved bool) (*types.Transaction, error) {
	return _SqrcTb1.contract.Transact(opts, "setApprovalForAll", operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_SqrcTb1 *SqrcTb1Session) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _SqrcTb1.Contract.SetApprovalForAll(&_SqrcTb1.TransactOpts, operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_SqrcTb1 *SqrcTb1TransactorSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _SqrcTb1.Contract.SetApprovalForAll(&_SqrcTb1.TransactOpts, operator, approved)
}

// SqrcTb1ApprovalForAllIterator is returned from FilterApprovalForAll and is used to iterate over the raw logs and unpacked data for ApprovalForAll events raised by the SqrcTb1 contract.
type SqrcTb1ApprovalForAllIterator struct {
	Event *SqrcTb1ApprovalForAll // Event containing the contract specifics and raw log
...
func (it *SqrcTb1ApprovalForAllIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SqrcTb1ApprovalForAll)
...
func (it *SqrcTb1ApprovalForAllIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SqrcTb1ApprovalForAllIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SqrcTb1ApprovalForAll represents a ApprovalForAll event raised by the SqrcTb1 contract.
type SqrcTb1ApprovalForAll struct {
...
func (_SqrcTb1 *SqrcTb1Filterer) FilterApprovalForAll(opts *bind.FilterOpts, account []common.Address, operator []common.Address) (*SqrcTb1ApprovalForAllIterator, error) {
	...
	logs, sub, err := _SqrcTb1.contract.FilterLogs(opts, "ApprovalForAll", accountRule, operatorRule)
	if err != nil {
		return nil, err
	}
	return &SqrcTb1ApprovalForAllIterator{contract: _SqrcTb1.contract, event: "ApprovalForAll", logs: logs, sub: sub}, nil
}

// WatchApprovalForAll is a free log subscription operation binding the contract event 0x17307eab39ab6107e8899845ad3d59bd9653f200f220920489ca2b5937696c31.
//
// Solidity: event ApprovalForAll(address indexed account, address indexed operator, bool approved)
func (_SqrcTb1 *SqrcTb1Filterer) WatchApprovalForAll(opts *bind.WatchOpts, sink chan<- *SqrcTb1ApprovalForAll, account []common.Address, operator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _SqrcTb1.contract.WatchLogs(opts, "ApprovalForAll", accountRule, operatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(SqrcTb1ApprovalForAll)
				if err := _SqrcTb1.contract.UnpackLog(event, "ApprovalForAll", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event ApprovalForAll(address indexed account, address indexed operator, bool approved)
func (_SqrcTb1 *SqrcTb1Filterer) ParseApprovalForAll(log types.Log) (*SqrcTb1ApprovalForAll, error) {
	event := new(SqrcTb1ApprovalForAll)
	if err := _SqrcTb1.contract.UnpackLog(event, "ApprovalForAll", log); err != nil {
		return nil, err
	}
...
// SqrcTb1TransferBatchIterator is returned from FilterTransferBatch and is used to iterate over the raw logs and unpacked data for TransferBatch events raised by the SqrcTb1 contract.
type SqrcTb1TransferBatchIterator struct {
	Event *SqrcTb1TransferBatch // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SqrcTb1TransferBatchIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SqrcTb1TransferBatch)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SqrcTb1TransferBatchIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SqrcTb1TransferBatchIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SqrcTb1TransferBatch represents a TransferBatch event raised by the SqrcTb1 contract.
type SqrcTb1TransferBatch struct {
	Operator common.Address
	From     common.Address
	To       common.Address
	Ids      []*big.Int
...
func (_SqrcTb1 *SqrcTb1Filterer) FilterTransferBatch(opts *bind.FilterOpts, operator []common.Address, from []common.Address, to []common.Address) (*SqrcTb1TransferBatchIterator, error) {
	...
	logs, sub, err := _SqrcTb1.contract.FilterLogs(opts, "TransferBatch", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &SqrcTb1TransferBatchIterator{contract: _SqrcTb1.contract, event: "TransferBatch", logs: logs, sub: sub}, nil
}

// WatchTransferBatch is a free log subscription operation binding the contract event 0x4a39dc06d4c0dbc64b70af90fd698a233a518aa5d07e595d983b8c0526c8f7fb.
//
// Solidity: event TransferBatch(address indexed operator, address indexed from, address indexed to, uint256[] ids, uint256[] values)
func (_SqrcTb1 *SqrcTb1Filterer) WatchTransferBatch(opts *bind.WatchOpts, sink chan<- *SqrcTb1TransferBatch, operator []common.Address, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _SqrcTb1.contract.WatchLogs(opts, "TransferBatch", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SqrcTb1TransferBatch)
				if err := _SqrcTb1.contract.UnpackLog(event, "TransferBatch", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TransferBatch(address indexed operator, address indexed from, address indexed to, uint256[] ids, uint256[] values)
func (_SqrcTb1 *SqrcTb1Filterer) ParseTransferBatch(log types.Log) (*SqrcTb1TransferBatch, error) {
	event := new(SqrcTb1TransferBatch)
	if err := _SqrcTb1.contract.UnpackLog(event, "TransferBatch", log); err != nil {
		return nil, err
	}
...
// SqrcTb1TransferSingleIterator is returned from FilterTransferSingle and is used to iterate over the raw logs and unpacked data for TransferSingle events raised by the SqrcTb1 contract.
type SqrcTb1TransferSingleIterator struct {
	Event *SqrcTb1TransferSingle // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SqrcTb1TransferSingleIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SqrcTb1TransferSingle)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SqrcTb1TransferSingleIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SqrcTb1TransferSingleIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SqrcTb1TransferSingle represents a TransferSingle event raised by the SqrcTb1 contract.
type SqrcTb1TransferSingle struct {
	Operator common.Address
	From     common.Address
	To       common.Address
	Id       *big.Int
...
func (_SqrcTb1 *SqrcTb1Filterer) FilterTransferSingle(opts *bind.FilterOpts, operator []common.Address, from []common.Address, to []common.Address) (*SqrcTb1TransferSingleIterator, error) {
	...
	logs, sub, err := _SqrcTb1.contract.FilterLogs(opts, "TransferSingle", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return &SqrcTb1TransferSingleIterator{contract: _SqrcTb1.contract, event: "TransferSingle", logs: logs, sub: sub}, nil
}

// WatchTransferSingle is a free log subscription operation binding the contract event 0xc3d58168c5ae7397731d063d5bbf3d657854427343f4c083240f7aacaa2d0f62.
//
// Solidity: event TransferSingle(address indexed operator, address indexed from, address indexed to, uint256 id, uint256 value)
func (_SqrcTb1 *SqrcTb1Filterer) WatchTransferSingle(opts *bind.WatchOpts, sink chan<- *SqrcTb1TransferSingle, operator []common.Address, from []common.Address, to []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _SqrcTb1.contract.WatchLogs(opts, "TransferSingle", operatorRule, fromRule, toRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SqrcTb1TransferSingle)
				if err := _SqrcTb1.contract.UnpackLog(event, "TransferSingle", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event TransferSingle(address indexed operator, address indexed from, address indexed to, uint256 id, uint256 value)
func (_SqrcTb1 *SqrcTb1Filterer) ParseTransferSingle(log types.Log) (*SqrcTb1TransferSingle, error) {
	event := new(SqrcTb1TransferSingle)
	if err := _SqrcTb1.contract.UnpackLog(event, "TransferSingle", log); err != nil {
		return nil, err
	}
...
// SqrcTb1URIIterator is returned from FilterURI and is used to iterate over the raw logs and unpacked data for URI events raised by the SqrcTb1 contract.
type SqrcTb1URIIterator struct {
	Event *SqrcTb1URI // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SqrcTb1URIIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SqrcTb1URIIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SqrcTb1URIIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SqrcTb1URI represents a URI event raised by the SqrcTb1 contract.
type SqrcTb1URI struct {
	Value string
	Id    *big.Int
	Raw   types.Log // Blockchain specific contextual infos
}
...
func (_SqrcTb1 *SqrcTb1Filterer) FilterURI(opts *bind.FilterOpts, id []*big.Int) (*SqrcTb1URIIterator, error) {
	...
	logs, sub, err := _SqrcTb1.contract.FilterLogs(opts, "URI", idRule)
	if err != nil {
		return nil, err
	}
	return &SqrcTb1URIIterator{contract: _SqrcTb1.contract, event: "URI", logs: logs, sub: sub}, nil
}

// WatchURI is a free log subscription operation binding the contract event 0x6bb7ff708619ba0610cba295a58592e0451dee2622938c8755667688daf3529b.
//
// Solidity: event URI(string value, uint256 indexed id)
func (_SqrcTb1 *SqrcTb1Filterer) WatchURI(opts *bind.WatchOpts, sink chan<- *SqrcTb1URI, id []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _SqrcTb1.contract.WatchLogs(opts, "URI", idRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SqrcTb1URI)
				if err := _SqrcTb1.contract.UnpackLog(event, "URI", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event URI(string value, uint256 indexed id)
func (_SqrcTb1 *SqrcTb1Filterer) ParseURI(log types.Log) (*SqrcTb1URI, error) {
	event := new(SqrcTb1URI)
	if err := _SqrcTb1.contract.UnpackLog(event, "URI", log); err != nil {
		return nil, err
	}
