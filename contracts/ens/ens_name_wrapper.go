...
func (_ENSNameWrapper *ENSNameWrapperTransactor) OnZRC721Received(opts *bind.TransactOpts, to common.Address, arg1 common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _ENSNameWrapper.contract.Transact(opts, "onZRC721Received", to, arg1, tokenId, data)
}

// OnZRC721Received is a paid mutator transaction binding the contract method 0x150b7a02.
//
// Solidity: function onZRC721Received(address to, address , uint256 tokenId, bytes data) returns(bytes4)
func (_ENSNameWrapper *ENSNameWrapperSession) OnZRC721Received(to common.Address, arg1 common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _ENSNameWrapper.Contract.OnZRC721Received(&_ENSNameWrapper.TransactOpts, to, arg1, tokenId, data)
}

// OnZRC721Received is a paid mutator transaction binding the contract method 0x150b7a02.
//
// Solidity: function onZRC721Received(address to, address , uint256 tokenId, bytes data) returns(bytes4)
func (_ENSNameWrapper *ENSNameWrapperTransactorSession) OnZRC721Received(to common.Address, arg1 common.Address, tokenId *big.Int, data []byte) (*types.Transaction, error) {
	return _ENSNameWrapper.Contract.OnZRC721Received(&_ENSNameWrapper.TransactOpts, to, arg1, tokenId, data)
}
