...
func (_QRNSDNSRegistrar *QRNSDNSRegistrarCaller) Zns(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _QRNSDNSRegistrar.contract.Call(opts, &out, "zns")
...
//
// Solidity: function zns() view returns(address)
func (_QRNSDNSRegistrar *QRNSDNSRegistrarSession) Zns() (common.Address, error) {
	return _QRNSDNSRegistrar.Contract.Zns(&_QRNSDNSRegistrar.CallOpts)
}

// Zns is a free data retrieval call binding the contract method 0x3f15457f.
//
// Solidity: function zns() view returns(address)
func (_QRNSDNSRegistrar *QRNSDNSRegistrarCallerSession) Zns() (common.Address, error) {
	return _QRNSDNSRegistrar.Contract.Zns(&_QRNSDNSRegistrar.CallOpts)
}
