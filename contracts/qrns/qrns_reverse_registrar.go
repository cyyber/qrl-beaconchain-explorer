...
func (_QRNSReverseRegistrar *QRNSReverseRegistrarCaller) Zns(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _QRNSReverseRegistrar.contract.Call(opts, &out, "zns")
...
//
// Solidity: function zns() view returns(address)
func (_QRNSReverseRegistrar *QRNSReverseRegistrarSession) Zns() (common.Address, error) {
	return _QRNSReverseRegistrar.Contract.Zns(&_QRNSReverseRegistrar.CallOpts)
}

// Zns is a free data retrieval call binding the contract method 0x3f15457f.
//
// Solidity: function zns() view returns(address)
func (_QRNSReverseRegistrar *QRNSReverseRegistrarCallerSession) Zns() (common.Address, error) {
	return _QRNSReverseRegistrar.Contract.Zns(&_QRNSReverseRegistrar.CallOpts)
}
